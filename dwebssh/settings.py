"""
Django settings for dwebssh project.
...
SECRET_KEY = '7*k*-le_gj6%1op%!@q6%y!9ejd2@h^p%cjnv+3fp885^veegb'
...
WSGI_APPLICATION = 'dwebssh.wsgi.application'
